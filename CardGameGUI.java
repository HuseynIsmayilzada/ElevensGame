...
public class CardGameGUI extends JFrame implements ActionListener {
    ...
    /** y coord of the "n undealt CardGame.cards remain" label. */
    private static final int LABEL_TOP = 160;
    /** x coord of the "n undealt CardGame.cards remain" label. */
    private static final int LABEL_LEFT = 540;
    /** Distance between the tops of the "n undealt CardGame.cards" and
     *  the "You lose/win" labels. */
    private static final int LABEL_HEIGHT_INC = 35;

    /** The board (CardGame.Board subclass). */
    private Board board;
    ...
    /** The "number of undealt CardGame.cards remain" message. */
    ...
    /**
     * Initialize the GUI.
     * @param gameBoard is a <code>CardGame.Board</code> subclass.
     */
    public CardGameGUI(Board gameBoard) {
        ...
        // Initialize cardCoords using 5 CardGame.cards per row
    ...
    /**
     * Draw the display (CardGame.cards and messages).
     */
    public void repaint() {
        for (int k = 0; k < board.size(); k++) {
            ...
            if (imageURL != null) {
                ...
                throw new RuntimeException(
                        "CardGame.Card image not found: \"" + cardImageFileName + "\"");
            }
        }
        statusMsg.setText(board.deckSize()
                + " undealt CardGame.cards remain.");
    ...
    private void initDisplay()	{
        ...
        statusMsg = new JLabel(
                board.deckSize() + " undealt CardGame.cards remain.");
        panel.add(statusMsg);
     ...
     *
     * @param c CardGame.Card to get the image for
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(replaceButton)) {
            // Gather all the selected CardGame.cards.
